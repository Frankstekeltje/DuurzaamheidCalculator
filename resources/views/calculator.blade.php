            ...
            <div class="row">
                <div class="col-sm-4">
                    @for ($i = 0; $i < $wallAmount; $i++)
                        ...
                        <br>
                        <input placeholder="Hoogte in mm" class="wall{{$i}}" type="text" name="wallHeight[]" onkeypress="return isNumber(event)">
                        <input placeholder="Breedte in mm" class="wall{{$i}}" type="text" name="wallWidth[]" onkeypress="return isNumber(event)">
                        <br>
                        <input placeholder="Temperatuur in de kamer" class="wall{{$i}}" type="text" name="wallTempOut[]" onkeypress="return isNumber(event)">
                        <input placeholder="Temperatuur buiten de kamer" class="wall{{$i}}" type="text" name="wallTempIn[]" onkeypress="return isNumber(event)">
                        <br>
                    @endfor
                    <br>
                ...
                <div class="col-sm-4">
                    @for ($i = 0; $i < $ceilingAmount; $i++)
                        <select class="ceiling{{$i}}" name="ceiling[]">
                        ...
                        <br>
                        <input placeholder="Hoogte in mm" class="ceiling{{$i}}" type="text" name="ceilingHeight[]" onkeypress="return isNumber(event)">
                        <input placeholder="Breedte in mm" class="ceiling{{$i}}" type="text" name="ceilingWidth[]" onkeypress="return isNumber(event)">
                        <br>
                        <input placeholder="Temp in de kamer" class="ceiling{{$i}}" type="text" name="ceilingTempOut[]" onkeypress="return isNumber(event)">
                        <input value="5" class="ceiling{{$i}}" type="text" name="ceilingTempIn[]" onkeypress="return isNumber(event)" disabled>
                        <br>
                    @endfor
                    <br>
                ...
                <div class="col-sm-4">
                    @for ($i = 0; $i < $floorAmount; $i++)
                        <select class="floor{{$i}}" name="floor[]">
                        ...
                        <br>
                        <input placeholder="Hoogte in mm" class="floor{{$i}}" type="text" name="floorHeight[]" onkeypress="return isNumber(event)">
                        <input placeholder="Breedte in mm" class="floor{{$i}}" type="text" name="floorWidth[]" onkeypress="return isNumber(event)">
                        <br>
                        <input placeholder="Temp in de kamer" class="floor{{$i}}" type="text" name="floorTempOut[]" onkeypress="return isNumber(event)">
                        <input value="-7" class="ceiling{{$i}}" type="text" name="ceilingTempIn[]" onkeypress="return isNumber(event)" disabled>
                        <br>
                    @endfor
                    <br>
